...
if(isset($account)){
	...
	<!--
	function delayer(){
	    window.location.href = "<?php echo $_GET['url']; ?>&action=create";
	}
	//-->
	</script>
	</head>
	...
	echo 'You have connected to Aweber, you will be re-direct back to your PopUp Domination. If you are not re-directed, please <a href="'.$_GET['url'].'&action=create">click here</a>.';
	echo '</body></html>';
}
