<div id="popup_domination_tabs" class="campaign-details">
	<div class="campaign-name-box">
		...
		<input id="campname" name="campname" type="text" value="<?php echo $campname; ?>" placeholder="Campaign Name..." />
		<div class="clear"></div>
	...
	<div class="campaign-description">
		...
		<input name="campaigndesc" type="text" value="<?php echo $campdesc; ?>" placeholder="Campaign Description..." />
